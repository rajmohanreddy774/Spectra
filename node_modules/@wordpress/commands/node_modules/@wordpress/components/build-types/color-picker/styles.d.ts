export declare const NumberControlWrapper: import("@emotion/styled").StyledComponent<Omit<import("../input-control/types").InputControlProps, "value" | "max" | "min" | "type" | "required" | "step" | "isDragEnabled"> & {
