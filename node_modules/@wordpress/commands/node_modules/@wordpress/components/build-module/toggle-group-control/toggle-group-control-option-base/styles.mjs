...
var LabelView = /* @__PURE__ */ _styled("div", process.env.NODE_ENV === "production" ? {
  target: "et6ln9s1"
} : {
  target: "et6ln9s1",
  label: "LabelView"
