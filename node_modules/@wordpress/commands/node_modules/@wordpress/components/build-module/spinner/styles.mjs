...
var spinAnimation = keyframes`
 ...
 `;
var StyledSpinner = /* @__PURE__ */ _styled("svg", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq2"
} : {
  target: "ea4tfvq2",
  label: "StyledSpinner"
...
var SpinnerTrack = /* @__PURE__ */ _styled("circle", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq1"
} : {
  target: "ea4tfvq1",
  label: "SpinnerTrack"
...
var SpinnerIndicator = /* @__PURE__ */ _styled("path", process.env.NODE_ENV === "production" ? {
  target: "ea4tfvq0"
} : {
  target: "ea4tfvq0",
