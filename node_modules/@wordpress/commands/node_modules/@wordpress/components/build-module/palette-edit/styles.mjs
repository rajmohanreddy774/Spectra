...
import { Container as InputControlContainer, Input, BackdropUI as InputBackdropUI } from "../input-control/styles/input-control-styles.mjs";
import ColorIndicator from "../color-indicator/index.mjs";
function _EMOTION_STRINGIFIED_CSS_ERROR__() {
  return "You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";
}
var IndicatorStyled = /* @__PURE__ */ _styled(ColorIndicator, process.env.NODE_ENV === "production" ? {
  target: "e1lpqc908"
} : {
  target: "e1lpqc908",
...
var NameInputControl = /* @__PURE__ */ _styled(InputControl, process.env.NODE_ENV === "production" ? {
  target: "e1lpqc907"
} : {
  target: "e1lpqc907",
...
var NameContainer = /* @__PURE__ */ _styled("div", process.env.NODE_ENV === "production" ? {
  target: "e1lpqc906"
} : {
  target: "e1lpqc906",
  label: "NameContainer"
...
var PaletteHeading = /* @__PURE__ */ _styled(Heading, process.env.NODE_ENV === "production" ? {
  target: "e1lpqc905"
} : {
  target: "e1lpqc905",
...
var PaletteActionsContainer = /* @__PURE__ */ _styled(View, process.env.NODE_ENV === "production" ? {
  target: "e1lpqc904"
} : {
  target: "e1lpqc904",
...
var PaletteEditContents = /* @__PURE__ */ _styled(View, process.env.NODE_ENV === "production" ? {
  target: "e1lpqc903"
} : {
  target: "e1lpqc903",
...
var PaletteEditStyles = /* @__PURE__ */ _styled(View, process.env.NODE_ENV === "production" ? {
  target: "e1lpqc902"
} : {
  target: "e1lpqc902",
...
var DoneButton = /* @__PURE__ */ _styled(Button, process.env.NODE_ENV === "production" ? {
  target: "e1lpqc901"
} : {
  target: "e1lpqc901",
  label: "DoneButton"
