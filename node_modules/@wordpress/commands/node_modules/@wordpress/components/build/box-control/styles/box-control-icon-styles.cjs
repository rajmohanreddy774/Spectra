...
var Root = /* @__PURE__ */ (0, import_base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z8"
} : {
  target: "e1j5nr4z8",
  label: "Root"
...
var Viewbox = /* @__PURE__ */ (0, import_base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z7"
} : {
  target: "e1j5nr4z7",
  label: "Viewbox"
...
var Stroke = /* @__PURE__ */ (0, import_base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z6"
} : {
  target: "e1j5nr4z6",
  label: "Stroke"
...
var VerticalStroke = /* @__PURE__ */ (0, import_base.default)(Stroke, process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z5"
} : {
  target: "e1j5nr4z5",
...
var HorizontalStroke = /* @__PURE__ */ (0, import_base.default)(Stroke, process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z4"
} : {
  target: "e1j5nr4z4",
...
var TopStroke = /* @__PURE__ */ (0, import_base.default)(HorizontalStroke, process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z3"
} : {
  target: "e1j5nr4z3",
  label: "TopStroke"
...
var RightStroke = /* @__PURE__ */ (0, import_base.default)(VerticalStroke, process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z2"
} : {
  target: "e1j5nr4z2",
  label: "RightStroke"
...
var BottomStroke = /* @__PURE__ */ (0, import_base.default)(HorizontalStroke, process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z1"
} : {
  target: "e1j5nr4z1",
  label: "BottomStroke"
...
var LeftStroke = /* @__PURE__ */ (0, import_base.default)(VerticalStroke, process.env.NODE_ENV === "production" ? {
  target: "e1j5nr4z0"
} : {
  target: "e1j5nr4z0",
  label: "LeftStroke"
...
//# sourceMappingURL=box-control-icon-styles.cjs.map
