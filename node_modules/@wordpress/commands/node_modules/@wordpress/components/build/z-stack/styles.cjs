...
var ZStackChildView = /* @__PURE__ */ (0, import_base.default)("div", process.env.NODE_ENV === "production" ? {
  target: "ebn2ljm1"
} : {
  target: "ebn2ljm1",
...
var ZStackView = /* @__PURE__ */ (0, import_base.default)("div", process.env.NODE_ENV === "production" ? {
  target: "ebn2ljm0"
} : {
  target: "ebn2ljm0",
  label: "ZStackView"
