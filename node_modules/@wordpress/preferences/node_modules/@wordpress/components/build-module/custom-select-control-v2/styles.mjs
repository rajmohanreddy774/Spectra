...
import { chevronIconSize } from "../select-control/styles/select-control-styles.mjs";
import { fontSizeStyles } from "../input-control/styles/input-control-styles.mjs";
import { DROPDOWN_MOTION_CSS } from "../utils/style-mixins.mjs";
...
var Select2 = /* @__PURE__ */ _styled(Ariakit.Select, process.env.NODE_ENV === "production" ? {
...
var SelectPopover2 = /* @__PURE__ */ _styled(Ariakit.SelectPopover, process.env.NODE_ENV === "production" ? {
  target: "e1p3eej76"
} : {
  target: "e1p3eej76",
  label: "SelectPopover"
...
var SelectItem2 = /* @__PURE__ */ _styled(Ariakit.SelectItem, process.env.NODE_ENV === "production" ? {
  target: "e1p3eej75"
} : {
  target: "e1p3eej75",
  label: "SelectItem"
...
var SelectedExperimentalHintWrapper = /* @__PURE__ */ _styled("div", process.env.NODE_ENV === "production" ? {
  target: "e1p3eej74"
} : {
  target: "e1p3eej74",
...
var SelectedExperimentalHintItem = /* @__PURE__ */ _styled("span", process.env.NODE_ENV === "production" ? {
  target: "e1p3eej73"
} : {
  target: "e1p3eej73",
...
var WithHintItemWrapper = /* @__PURE__ */ _styled("div", process.env.NODE_ENV === "production" ? {
  target: "e1p3eej72"
} : {
  target: "e1p3eej72",
...
var WithHintItemHint = /* @__PURE__ */ _styled("span", process.env.NODE_ENV === "production" ? {
  target: "e1p3eej71"
} : {
  target: "e1p3eej71",
...
var SelectedItemCheck = /* @__PURE__ */ _styled(Ariakit.SelectItemCheck, process.env.NODE_ENV === "production" ? {
  target: "e1p3eej70"
} : {
  target: "e1p3eej70",
...
export {
  ...
  SelectPopover2 as SelectPopover,
