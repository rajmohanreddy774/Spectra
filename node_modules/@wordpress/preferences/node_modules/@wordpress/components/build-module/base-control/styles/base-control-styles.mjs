...
import { baseLabelTypography, boxSizingReset, font, COLORS } from "../../utils/index.mjs";
...
var StyledField = /* @__PURE__ */ _styled("div", process.env.NODE_ENV === "production" ? {
  target: "ej5x27r3"
} : {
  target: "ej5x27r3",
  label: "StyledField"
...
var labelStyles = /* @__PURE__ */ css(baseLabelTypography, ";display:block;margin-bottom:", space(2), ";padding:0;" + (process.env.NODE_ENV === "production" ? "" : ";label:labelStyles;"), process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
var StyledLabel = /* @__PURE__ */ _styled("label", process.env.NODE_ENV === "production" ? {
  target: "ej5x27r2"
} : {
  target: "ej5x27r2",
  label: "StyledLabel"
...
var StyledHelp = /* @__PURE__ */ _styled("p", process.env.NODE_ENV === "production" ? {
  target: "ej5x27r1"
} : {
  target: "ej5x27r1",
  label: "StyledHelp"
...
var StyledVisualLabel = /* @__PURE__ */ _styled("span", process.env.NODE_ENV === "production" ? {
  target: "ej5x27r0"
} : {
  target: "ej5x27r0",
...
//# sourceMappingURL=base-control-styles.mjs.map
