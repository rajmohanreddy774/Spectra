...
var StyledInputControl = /* @__PURE__ */ (0, import_base.default)(import_input_control.default, process.env.NODE_ENV === "production" ? {
  target: "effl84m1"
} : {
  target: "effl84m1",
...
var StyledIcon = /* @__PURE__ */ (0, import_base.default)(import_icon.default, process.env.NODE_ENV === "production" ? {
  target: "effl84m0"
} : {
  target: "effl84m0",
  label: "StyledIcon"
