...
function TimePicker({
  ...
  const [date, setDate] = (0, import_element.useState)(() => (
    ...
    (0, import_date_fns.startOfMinute)((0, import_utils.inputToDate)(currentTime !== null && currentTime !== void 0 ? currentTime : /* @__PURE__ */ new Date()))
  ));
  (0, import_element.useEffect)(() => {
    setDate((0, import_date_fns.startOfMinute)((0, import_utils.inputToDate)(currentTime !== null && currentTime !== void 0 ? currentTime : /* @__PURE__ */ new Date())));
  }, [currentTime]);
  const monthOptions = [{
    value: "01",
