...
var StyledTabList = /* @__PURE__ */ (0, import_base.default)(Ariakit.TabList, process.env.NODE_ENV === "production" ? {
  target: "enfox0g4"
} : {
  target: "enfox0g4",
  label: "StyledTabList"
...
var Tab2 = /* @__PURE__ */ (0, import_base.default)(Ariakit.Tab, process.env.NODE_ENV === "production" ? {
  target: "enfox0g3"
} : {
  target: "enfox0g3",
  label: "Tab"
...
var TabChildren = /* @__PURE__ */ (0, import_base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "enfox0g2"
} : {
  target: "enfox0g2",
  label: "TabChildren"
...
var TabChevron = /* @__PURE__ */ (0, import_base.default)(import_icon.default, process.env.NODE_ENV === "production" ? {
  target: "enfox0g1"
} : {
  target: "enfox0g1",
  label: "TabChevron"
...
var TabPanel2 = /* @__PURE__ */ (0, import_base.default)(Ariakit.TabPanel, process.env.NODE_ENV === "production" ? {
  target: "enfox0g0"
} : {
  target: "enfox0g0",
  label: "TabPanel"
