...
var UnforwardedValidatedCheckboxControl = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_control_with_error.ControlWithError, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_checkbox_control.default,
      {
        ...restProps
      }
    )
...
var ValidatedCheckboxControl = (0, import_element.forwardRef)(UnforwardedValidatedCheckboxControl);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  ValidatedCheckboxControl
});
//# sourceMappingURL=checkbox-control.cjs.map
