...
var navigatorWrapper = process.env.NODE_ENV === "production" ? {
  name: "1br0vvk",
...
var fadeOut = (0, import_react.keyframes)({
  to: {
    opacity: 0
  }
});
var slideFromRight = (0, import_react.keyframes)({
  from: {
    transform: "translateX(100px)"
  }
});
var slideToLeft = (0, import_react.keyframes)({
  to: {
    transform: "translateX(-80px)"
  }
});
var slideFromLeft = (0, import_react.keyframes)({
  from: {
    transform: "translateX(-100px)"
  }
});
var slideToRight = (0, import_react.keyframes)({
  to: {
    transform: "translateX(80px)"
  }
});
