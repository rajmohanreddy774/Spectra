import type { SwiperOptions } from './swiper-options.ts';
import type { CSSSelector, SwiperModule } from './shared.ts';
import type { SwiperEvents } from './swiper-events.ts';

import type { A11yMethods } from './modules/a11y.ts';
import type { AutoplayMethods } from './modules/autoplay.ts';
import type { ControllerMethods } from './modules/controller.ts';
import type { CoverflowEffectMethods } from './modules/effect-coverflow.ts';
import type { CubeEffectMethods } from './modules/effect-cube.ts';
import type { FadeEffectMethods } from './modules/effect-fade.ts';
import type { FlipEffectMethods } from './modules/effect-flip.ts';
import type { CreativeEffectMethods } from './modules/effect-creative.ts';
import type { CardsEffectMethods } from './modules/effect-cards.ts';
import type { HashNavigationMethods } from './modules/hash-navigation.ts';
import type { HistoryMethods } from './modules/history.ts';
import type { KeyboardMethods } from './modules/keyboard.ts';
import type { MousewheelMethods } from './modules/mousewheel.ts';
import type { NavigationMethods } from './modules/navigation.ts';
import type { PaginationMethods } from './modules/pagination.ts';
import type { ParallaxMethods } from './modules/parallax.ts';
import type { ScrollbarMethods } from './modules/scrollbar.ts';
import type { ThumbsMethods } from './modules/thumbs.ts';
import type { VirtualMethods } from './modules/virtual.ts';
import type { ZoomMethods } from './modules/zoom.ts';
import type { FreeModeMethods } from './modules/free-mode.ts';
import type { ManipulationMethods } from './modules/manipulation.ts';
