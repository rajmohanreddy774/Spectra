...
import type Swiper from './swiper-class.ts';

import type { A11yEvents } from './modules/a11y.ts';
import type { AutoplayEvents } from './modules/autoplay.ts';
import type { ControllerEvents } from './modules/controller.ts';
import type { CoverflowEffectEvents } from './modules/effect-coverflow.ts';
import type { CubeEffectEvents } from './modules/effect-cube.ts';
import type { FadeEffectEvents } from './modules/effect-fade.ts';
import type { FlipEffectEvents } from './modules/effect-flip.ts';
import type { CreativeEffectEvents } from './modules/effect-creative.ts';
import type { CardsEffectEvents } from './modules/effect-cards.ts';
import type { HashNavigationEvents } from './modules/hash-navigation.ts';
import type { HistoryEvents } from './modules/history.ts';
import type { KeyboardEvents } from './modules/keyboard.ts';
import type { MousewheelEvents } from './modules/mousewheel.ts';
import type { NavigationEvents } from './modules/navigation.ts';
import type { PaginationEvents } from './modules/pagination.ts';
import type { ParallaxEvents } from './modules/parallax.ts';
import type { ScrollbarEvents } from './modules/scrollbar.ts';
import type { ThumbsEvents } from './modules/thumbs.ts';
import type { VirtualEvents } from './modules/virtual.ts';
import type { ZoomEvents } from './modules/zoom.ts';
import type { FreeModeEvents } from './modules/free-mode.ts';
