import type { A11yOptions } from './modules/a11y.ts';
import type { AutoplayOptions } from './modules/autoplay.ts';
import type { ControllerOptions } from './modules/controller.ts';
import type { CoverflowEffectOptions } from './modules/effect-coverflow.ts';
import type { CubeEffectOptions } from './modules/effect-cube.ts';
import type { FadeEffectOptions } from './modules/effect-fade.ts';
import type { FlipEffectOptions } from './modules/effect-flip.ts';
import type { CreativeEffectOptions } from './modules/effect-creative.ts';
import type { CardsEffectOptions } from './modules/effect-cards.ts';
import type { HashNavigationOptions } from './modules/hash-navigation.ts';
import type { HistoryOptions } from './modules/history.ts';
import type { KeyboardOptions } from './modules/keyboard.ts';
import type { MousewheelOptions } from './modules/mousewheel.ts';
import type { NavigationOptions } from './modules/navigation.ts';
import type { PaginationOptions } from './modules/pagination.ts';
import type { ParallaxOptions } from './modules/parallax.ts';
import type { ScrollbarOptions } from './modules/scrollbar.ts';
import type { ThumbsOptions } from './modules/thumbs.ts';
import type { VirtualOptions } from './modules/virtual.ts';
import type { ZoomOptions } from './modules/zoom.ts';
import type { FreeModeOptions } from './modules/free-mode.ts';
import type { GridOptions } from './modules/grid.ts';
